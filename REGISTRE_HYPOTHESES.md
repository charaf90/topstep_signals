...
| **fib-v4.1** (MES1+NQ1) | 🔴 **ABANDONNÉE** | OOS pool **0.85 (−$827)**, IS **et** OOS faibles. L'edge M15 (causal inclus) était **un artefact same-bar** (11/29 trades M15 résolus à la bougie de fill). **Décision user 2026-06-18 : oublier, redévelopper FROM SCRATCH** comme nouvelle strat (cf. BACKLOG). ⚠️ **Reste ACTIVE en live (MES1+NQ1)** — décision de désactiver = utilisateur (pas touché). |
