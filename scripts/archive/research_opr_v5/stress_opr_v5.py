"""
Stress tests OPR v5 (PHASE 5 du pipeline).

Calcule la performance de v5 (params optimaux config) sur les sous-segments :
...
Sortie : output/stress_opr_v5.md
"""
...
def main() -> int:
    print("=" * 70)
    print("  STRESS TESTS opr-v5 (params optimaux)")
    print("=" * 70)
    ...
    rows.append("")
    rows.append("## Comparaison directe v4 vs v5 sur jours OOS")
    rows.append("")
